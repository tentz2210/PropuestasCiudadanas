...
public class CategoryStatisticWindow extends javax.swing.JFrame {

    /**
     * Creates new form citizenWindow
     */
    public CategoryStatisticWindow() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Estadísticas por Categoría");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoryStatisticWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategoryStatisticWindow().setVisible(true);
            }
        });
    }
    ...
    private void generateCategoryChart()
    {
        try {
            ResultSet r;
            r = ConnectDB.getStatisticsPerCategory();
            generateChart(r);
        } catch (SQLException ex) {
            Logger.getLogger(CategoryStatisticWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

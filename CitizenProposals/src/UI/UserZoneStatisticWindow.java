...
public class UserZoneStatisticWindow extends javax.swing.JFrame {

    /**
     * Creates new form citizenWindow
     */
    public UserZoneStatisticWindow() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Estadística por Zona de Usuarios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserZoneStatisticWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserZoneStatisticWindow().setVisible(true);
            }
        });
    }
    ...
    private void generateUserZoneChart()
    {
        ...
        try{
            ...
            {
                case "País":
                    r = ConnectDB.getStatisticsPerUserCountry();
                    generateChart(r);
                    break;
                case "Provincia":
                    r = ConnectDB.getStatisticsPerUserProvince();
                    generateChart(r);
                    break;
                case "Cantón":
                    r = ConnectDB.getStatisticsPerUserCanton();
                    generateChart(r);
                    break;
                case "Distrito":
                    r = ConnectDB.getStatisticsPerUserDistrict();
                    generateChart(r);
                    break;
                case "Comunidad":
                    r = ConnectDB.getStatisticsPerUserCommunity();
                    generateChart(r);
                    break;
                default:
            }
